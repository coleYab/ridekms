...
- **Authentication**: Custom authentication (implement your own)
...
- Multi-tenant workspaces support (implement your own)
- Client-side RBAC for navigation visibility (implement your own)
...
│   ├── auth/              # Authentication routes (if implementing auth)
...
│   │   ├── exclusive/     # Premium feature example
...
│   ├── auth/              # Authentication components (if implementing auth)
...
Dashboard routes use custom authentication. Pages that require authentication:

```tsx
import { auth } from '@/lib/auth'; // implement your own
...
Implement your own protection patterns based on your authentication system.
