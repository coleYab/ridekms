      ...
      <div className='mx-auto max-w-3xl'>
        ...
        <div className='space-y-8'>
          ...
          <section className='bg-card rounded-2xl border p-8 shadow-sm'>
            ...
            <p className='text-muted-foreground text-lg leading-relaxed'>
              Authentication for this application is handled securely. The system provides secure
              sign-in, session management, and user data protection to ensure your information
              remains safe.
            </p>
          </section>
