    ...
    <div className='min-h-screen px-4 py-12 sm:px-6 lg:px-8'>
      <div className='mx-auto max-w-3xl space-y-8'>
        ...
        <section>
          ...
          <p className='text-muted-foreground text-base leading-relaxed'>
            Our application uses secure authentication to handle user identity. All authentication
            processes, including sign-up, sign-in, and password management, are handled securely.
            We are committed to protecting your personal information and following best practices for
            data security.
          </p>
        </section>
